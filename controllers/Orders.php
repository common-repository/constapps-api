...
/*
 * Base REST Controller for ConstApps
 *
 * @since 1.4.0
 *
 * @package Orders
...
{
    protected $namespace = 'constapps/v1';
    protected $base = 'cache';

    public function __construct()
    {
        add_action('rest_api_init', array($this, 'register_constapps_routes'));
    ...
    public function register_constapps_routes()
    {
